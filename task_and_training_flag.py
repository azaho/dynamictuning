...
additional_comments = [
    ...
    "Additional ordinal output is added"
]
...
class Task:
    ...
    def _make_trial(orientation1, orientation2, delay0, delay1, delay2):
        ...
        # calculate whether o2 is clockwise of o1
        ...
        o_cue = torch.zeros(task_parameters["dim_output"])
        o_cue[:4] = Task._output_orientation_representation(orientation1, orientation2)
        o_cue[4] = int(cw)
        o_cue = o_cue.repeat(task_parameters["show_cue_for"], 1)
    ...
    def calculate_errors(target, output, mask, t_from, t_to):
        ...
        return mse_o1, mse_o2, mse_f, angle_error_o1, angle_error_o2
